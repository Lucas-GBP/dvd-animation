...
class colisionObject {
    ...
    borderColision(width:number, height:number){
    ...
    boxColision(obj: colisionObject){
        //Overlap
...
class DvDObject {
    ...
    simpleEntityColision(obj: colisionObject){
