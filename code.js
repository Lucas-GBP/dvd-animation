...
animatedDiv.innerHTML = svgLogo(randomColor());
[animatedDiv.style.left, animatedDiv.style.top] = randomPosition();
const aniObject = {
    width: animatedDiv.offsetWidth,
    height: animatedDiv.offsetHeight,
